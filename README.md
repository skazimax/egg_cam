...
Проблемы автоматического определения момента сбора яиц, рассмотренные варианты
и рекомендуемая последовательность внедрения описаны в
[`FUTURE_IMPROVEMENTS.md`](FUTURE_IMPROVEMENTS.md). Ближайший рекомендуемый
этап — подтверждение сброса сессии оператором через Telegram с сохранением
контрольного кадра и аудита.
