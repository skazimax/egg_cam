...
резервный счётчик. Резервное условие работает и тогда, когда максимум сессии не
успел пройти `collection_arm_checks`; это не даёт сессии зависнуть после быстрой
серии подтверждения.
