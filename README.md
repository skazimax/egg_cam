...
обнуляет максимум сессии. Любое яйцо, перекрытие курицей или непохожий на эталон
кадр отменяет сброс. Старые arming и fallback-счётчики больше не используются.
